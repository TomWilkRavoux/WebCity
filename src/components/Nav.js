...
const Nav = () => {
  return (
    <nav className='fixed bottom-2 lg:bottom-8 w-full overflow-hidden z-50 flex justify-center'> 
      <div className='mx-auto sm:w-1/2 md:w-1/3 left-1/2 transform -translate-x-1/2 translate-x-5.0'>
        <div className='w-full bg-black/20 h-[96px] backdrop-blur-2xl rounded-full px-5 flex justify-between items-center text-2x1 text-white/50'>
